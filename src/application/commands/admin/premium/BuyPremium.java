...
/**
 * Class for buy premium command
 */
@Getter
public final class BuyPremium extends PlayerRelatedCommands {
     ...
     * @param players
     */
    public BuyPremium(final String command, final String username,
    ...
    public void startCommand(final ObjectMapper objectMapper, final ArrayNode outputs) {
        ...
        // we check if it is not already a premium subscriber
        if (user.isPremium()) {
